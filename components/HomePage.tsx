...
const HomePage: React.FC<HomePageProps> = ({ onStart }) => {
  return (
    <div className="h-full bg-gradient-to-br from-blue-50 via-white to-red-50 overflow-y-auto">
      {/* Hero Section */}
      <section className="min-h-[85vh] flex flex-col items-center justify-center text-center px-4 md:px-6 pt-8 md:pt-12 pb-16 md:pb-20">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-blue-900 leading-tight mb-4 md:mb-6">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed px-2">
      ...
      <section className="bg-white py-16 md:py-24 px-4 md:px-6 border-t border-blue-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
            {/* Card 1 */}
            <div className="p-6 md:p-8 rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 bg-white group hover:-translate-y-1">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-orange-50 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                <BrainCircuit className="w-6 h-6 md:w-7 md:h-7 text-orange-600" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-blue-900 mb-2 md:mb-3">AI-Driven Questions</h3>
            ...
            {/* Card 2 */}
            <div className="p-6 md:p-8 rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 bg-white group hover:-translate-y-1">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-blue-50 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                <Code className="w-6 h-6 md:w-7 md:h-7 text-blue-600" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-blue-900 mb-2 md:mb-3">Live Coding Environment</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            {/* Card 3 */}
            <div className="p-6 md:p-8 rounded-2xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 bg-white group hover:-translate-y-1">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-green-50 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300">
                <ClipboardCheck className="w-6 h-6 md:w-7 md:h-7 text-green-600" />
              </div>
              <h3 className="text-lg md:text-xl font-bold text-blue-900 mb-2 md:mb-3">Transcript & Analysis</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
